          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 dark:text-white leading-tight">
                Ready to Scale? We'll Handle the Red Tape.
              </h1>
              <p className="mt-6 text-lg lg:text-xl text-slate-600 dark:text-slate-300 max-w-xl mx-auto lg:mx-0">
                Expanding your business in Indonesia brings new challenges—from product registrations to hiring talent. Let us manage the complexities so you can focus on growth.
              </p>
              <div className="mt-10">
            ...
            <div className="flex items-center justify-center">
              <img
                ...
                src="/assets/business-team-looking.webp"
                alt="Business team looking at a city map"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-300">
              Once your company is established, growth brings new compliance needs. We're here to help you navigate them.
            </p>
          </div>
