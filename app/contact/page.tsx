  ...
  return (
    ...
    <Layout>
      <main>
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 text-center md:py-24 animate-in fade-in slide-in-from-bottom-2 duration-700">
              ...
              <div className="flex flex-col space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@example.com" className="mt-1 block text-primary hover:underline">
                      hello@example.com
                    </a>
                  </div>
                </div>
